...
/** @name Special modes Commands */
// @{
/** @brief Sound control for smarter domophone
 *
 * Cluster: Special modes, DomoPhone sound control
 * Command: OnOffSound
 * @param args uint8_t
 */
#define emberAfFillCommandGsDomophoneSpecificClusterOnOffSound(args) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_GS_DOMOPHONE_SPECIFIC_CLUSTER_ID, \
                                                0x1002, \
                                                ZCL_ON_OFF_SOUND_COMMAND_ID, \
                                                "u", \
                                                args);


/** @} END Special modes Commands */
