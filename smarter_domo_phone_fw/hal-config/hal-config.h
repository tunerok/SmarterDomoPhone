...
// $[Custom pin names]
#define Incoming_call_pin_PIN                 (6U)
#define Incoming_call_pin_PORT                (gpioPortA)

#define Take_phone_pin_PIN                    (8U)
#define Take_phone_pin_PORT                   (gpioPortA)

#define Open_pin_PIN                          (9U)
#define Open_pin_PORT                         (gpioPortA)
...
#define Sound_check_pin_PIN                   (10U)
#define Sound_check_pin_PORT                  (gpioPortC)

#define LED1_out_pin_PIN                      (3U)
#define LED1_out_pin_PORT                     (gpioPortF)

#define LED2_out_pin_PIN                      (4U)
#define LED2_out_pin_PORT                     (gpioPortF)

#define Sound_up_pin_PIN                      (5U)
#define Sound_up_pin_PORT                     (gpioPortF)

#define Sound_down_pin_PIN                    (6U)
#define Sound_down_pin_PORT                   (gpioPortF)
