...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/home/igor/Downloads/SimplicityStudio-5/SimplicityStudio_v5/developer/toolchains/gnu_arm/10.2_2020q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print (" ")
    EBL_COMMAND = START_FLAGS + shortPath(r"/home/igor/Downloads/SimplicityStudio-5/SimplicityStudio_v5/developer/adapter_packs/commander/commander").replace(
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"/home/igor/Downloads/SimplicityStudio-5/SimplicityStudio_v5/developer/adapter_packs/commander/commander").replace(
