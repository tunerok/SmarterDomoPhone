...
// Printing macros for cluster: Special modes
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_GS_DOMOPHONE_SPECIFIC_CLUSTER)
#define emberAfGsDomophoneSpecificClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_GS_DOMOPHONE_SPECIFIC_CLUSTER, __VA_ARGS__)
#define emberAfGsDomophoneSpecificClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_GS_DOMOPHONE_SPECIFIC_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfGsDomophoneSpecificClusterFlush()
#define emberAfGsDomophoneSpecificClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_GS_DOMOPHONE_SPECIFIC_CLUSTER) ) { x; }
#define emberAfGsDomophoneSpecificClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_GS_DOMOPHONE_SPECIFIC_CLUSTER, (buffer), (len), (withSpace))
#define emberAfGsDomophoneSpecificClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_GS_DOMOPHONE_SPECIFIC_CLUSTER, (buffer))
#else
#define emberAfGsDomophoneSpecificClusterPrint(...)
#define emberAfGsDomophoneSpecificClusterPrintln(...)
#define emberAfGsDomophoneSpecificClusterFlush()
#define emberAfGsDomophoneSpecificClusterDebugExec(x)
#define emberAfGsDomophoneSpecificClusterPrintBuffer(buffer, len, withSpace)
#define emberAfGsDomophoneSpecificClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_GS_DOMOPHONE_SPECIFIC_CLUSTER)
